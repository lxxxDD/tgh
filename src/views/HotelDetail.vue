...
const mockReviews = [
  {
    ...
    rating: 5,
    date: '2024-01-15',
    content: '酒店位置很好，房间干净整洁，服务人员态度友好。早餐丰富多样，整体入住体验非常满意。'
  },
  {
    id: 2,
    userName: '李女士',
    rating: 4,
    date: '2024-01-10',
    content: '房间设施齐全，床品舒适。唯一不足是停车需要额外收费，其他方面都很不错。'
  },
  {
    id: 3,
    userName: '王先生',
    rating: 5,
    date: '2024-01-05',
    content: '五星级标准，服务一流。健身房和游泳池设施很好，下次还会选择这里。'
  }
]
...
const submitBooking = async () => {
  ...
  try {
    ...
    ElMessage.error(error.response?.data?.message || error.message || '预订失败，请重试')
  }
}
